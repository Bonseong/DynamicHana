...
public class DashboardVO {
	...
	public DashboardVO(int cnt, int compareValue, double ratio, String historyDate, int subTotal, double subTotalDouble,
			String clusterNo, String category, int lastMonth, int thisMonth, String cardName, int morning, int lunch,
			int dinner, int night) {
		super();
		this.cnt = cnt;
	...
	public String toString() {
		return "DashboardVO [cnt=" + cnt + ", compareValue=" + compareValue + ", ratio=" + ratio + ", historyDate="
				...
				+ clusterNo + ", category=" + category + ", lastMonth=" + lastMonth + ", thisMonth=" + thisMonth
				+ ", cardName=" + cardName + ", morning=" + morning + ", lunch=" + lunch + ", dinner=" + dinner
				+ ", night=" + night + "]";
	}
